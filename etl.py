...
def process_log_file(cur, filepath):
    """
    This procedure processes a log file whose file path has been provided as an arguement. 
    It extracts the log information inorder to store it into the time, user and songplay table.  
...
def process_data(cur, conn, filepath, func):
    """Loops through all files and processes the files."""
    all_files = []
...
def main():
    """
    Creates connection to sparkifydb and processes logs and song JSON files.
